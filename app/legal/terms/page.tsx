  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <p className="mt-10 text-sm text-muted-foreground">
        ...
        , and{" "}
        <Link href="/support/food-safety" className="text-primary underline-offset-4 hover:underline">
          Food Safety
        </Link>
        .
      </p>
...
export default function TermsPage() {
  return <LegalPage title="Terms of Service" sections={legalSections.terms} />
}
