...
const footerLinks = {
  ...
  nutrition: [
    ...
    { label: "Bring ITK to your Neighborhood", href: "/for-cooks/bring-itk-to-your-neighborhood" },
  ],
  support: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 pt-8 border-t-2 border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} In The Kitchen. Made with love for our community.
          </p>
